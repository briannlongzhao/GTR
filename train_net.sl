...
# Evaluate only
python train_net.py --config-file configs/GTR_BDD_DR2102_C2.yaml --eval-only --visualize OUTPUT_DIR "./output/${SLURM_JOBID}/GTR_BDD/auto" MODEL.WEIGHTS models/best.pth
